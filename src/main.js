...
import { create, NSelect, NConfigProvider, NMessageProvider, NModal, 
  ...
  NCollapseItem, NPopover, NSpin, NDialogProvider, NInputGroup, NButton, NImage } from 'naive-ui'
...
const naive = create({
  components: [ NSelect, NConfigProvider, NMessageProvider, 
    ...
    NCollapse, NCollapseItem, NPopover, NSpin, NDialogProvider, NInputGroup, NImage ]
})
